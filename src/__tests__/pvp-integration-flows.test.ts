...
import { buildDisconnectForfeitOutcome, runDisconnectForfeitSequence } from "../../services/pvp-gateway/src/disconnect-forfeit";
...
import { getPublicRoomStartCondition, selectNextRoomHost } from "../../services/pvp-gateway/src/rooms/lifecycle";
import type { ConnectionUser, MatchState, QueueEntry } from "../../services/pvp-gateway/src/state";
