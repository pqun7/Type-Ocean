...
const Footer = () => {
  return (
    <footer className="w-full mt-auto">
      <Section crosses className="!py-10 overflow-hidden h-40 relative">
        <div className="container flex sm:justify-between justify-center items-center gap-10 max-sm:flex-col h-full relative z-10">
